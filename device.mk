...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/audio/audio_effects_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_effects_ZS661KS.xml \
    $(LOCAL_PATH)/configs/audio/audio_io_policy.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_io_policy.conf \
    $(LOCAL_PATH)/configs/audio/audio_io_policy_ZS661KS.conf:$(TARGET_COPY_OUT_VENDOR)/etc/audio_io_policy_ZS661KS.conf \
    $(LOCAL_PATH)/configs/audio/audio_platform_info.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_intcodec.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_intcodec.xml \
    $(LOCAL_PATH)/configs/audio/audio_platform_info_intcodec_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_platform_info_intcodec_ZS661KS.xml \
    ...
    $(LOCAL_PATH)/configs/audio/audio_policy_configuration_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_configuration_ZS661KS.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes.xml \
    $(LOCAL_PATH)/configs/audio/audio_policy_volumes_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/audio_policy_volumes_ZS661KS.xml \
    ...
    $(LOCAL_PATH)/configs/audio/inbox_audio_codec_reset.sh:$(TARGET_COPY_OUT_VENDOR)/etc/inbox_audio_codec_reset.sh \
    $(LOCAL_PATH)/configs/audio/inbox_audio_codec_switch_to_i2s.sh:$(TARGET_COPY_OUT_VENDOR)/etc/inbox_audio_codec_switch_to_i2s.sh \
    $(LOCAL_PATH)/configs/audio/inbox_audio_codec_switch_to_usb.sh:$(TARGET_COPY_OUT_VENDOR)/etc/inbox_audio_codec_switch_to_usb.sh \
    $(LOCAL_PATH)/configs/audio/mixer_paths.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths.xml \
    $(LOCAL_PATH)/configs/audio/mixer_paths_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/mixer_paths_ZS661KS.xml \
    ...
    $(LOCAL_PATH)/configs/audio/r_submix_audio_policy_configuration_ZS661KS.xml:$(TARGET_COPY_OUT_VENDOR)/etc/r_submix_audio_policy_configuration_ZS661KS.xml \
...
PRODUCT_PACKAGES += \
    ASUS_Sensor_dump.sh \
    AsusReInstallAttestationKey.sh \
    UTSdumpstate.sh \
    VibCali_ship.sh \
    WiFiFWTool.sh \
    WifiMac.sh \
...
# Inherit vendor
$(call inherit-product, vendor/asus/I003_1/I003_1-vendor.mk)